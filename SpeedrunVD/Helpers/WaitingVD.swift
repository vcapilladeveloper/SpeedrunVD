...
extension UIResponder {
    ...
    func noticeTop(_ text: String, autoClear: Bool = true, autoClearTime: Int = 1) -> UIWindow{
        return WaitingVD.noticeOnStatusBar(text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    
    // new apis from v3.3
    @discardableResult
    func noticeSuccess(_ text: String, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        return WaitingVD.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeError(_ text: String, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        return WaitingVD.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeInfo(_ text: String, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        return WaitingVD.showNoticeWithText(NoticeType.info, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    
    // old apis
    @discardableResult
    func successNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return WaitingVD.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    func errorNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return WaitingVD.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    ...
    func pleaseWait() -> UIWindow{
        return WaitingVD.wait()
    }
    @discardableResult
    func noticeOnlyText(_ text: String) -> UIWindow{
        return WaitingVD.showText(text)
    }
    func clearAllNotice() {
        WaitingVD.clear()
    }
...
class WaitingVD: NSObject {
    ...
    // fix https://github.com/johnlui/WaitingVD/issues/2
    // thanks broccolii(https://github.com/broccolii) and his PR https://github.com/johnlui/WaitingVD/pull/5
    static func clear() {
    ...
    static func showNoticeWithText(_ type: NoticeType,text: String, autoClear: Bool, autoClearTime: Int) -> UIWindow {
        ...
        switch type {
        case .success:
            image = WaitingVDSDK.imageOfCheckmark
        case .error:
            image = WaitingVDSDK.imageOfCross
        case .info:
            image = WaitingVDSDK.imageOfInfo
        }
...
class WaitingVDSDK {
    ...
    class var imageOfCheckmark: UIImage {
        ...
        WaitingVDSDK.draw(NoticeType.success)
    ...
    class var imageOfCross: UIImage {
        ...
        WaitingVDSDK.draw(NoticeType.error)
    ...
    class var imageOfInfo: UIImage {
        ...
        WaitingVDSDK.draw(NoticeType.info)
...
extension UIWindow{
    func hide() {
        WaitingVD.hideNotice(self)
    }
}

fileprivate extension Selector {
    static let hideNotice = #selector(WaitingVD.hideNotice(_:))
}

@objc extension WaitingVD {
